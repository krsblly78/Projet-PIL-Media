...
for (let i=0; i<n; i++){
  ...
  .fromTo(cube.querySelectorAll('.face'), {
    color: (j) => 'hsl(' + (i / n * 75 + 180) + ', 80%,' + (100 * [rots[3].a, rots[0].a, rots[1].a][j]) + '%)'
  }, {
    color: (j) => 'hsl(' + (i / n * 75 + 180) + ', 80%,' + (100 * [rots[0].a, rots[1].a, rots[2].a][j]) + '%)'
  }, 0)
  .to(cube.querySelectorAll('.face'), {
    color: (j) => 'hsl(' + (i / n * 75 + 200) + ', 80%,' + (100 * [rots[1].a, rots[2].a, rots[3].a][j]) + '%)'
  }, 1)
  .progress(i/n)
}
